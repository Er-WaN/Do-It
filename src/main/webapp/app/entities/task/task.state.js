    ...
    function stateConfig($stateProvider) {
        ...
        .state('task', {
            ...
            data: {
                ...
                pageTitle: 'doItApp.task.home.title'
            },
            views: {
                'content@': {
            ...
            resolve: {
                ...
                translatePartialLoader: ['$translate', '$translatePartialLoader', function ($translate, $translatePartialLoader) {
                    ...
                    $translatePartialLoader.addPart('taskDifficulty');
                    $translatePartialLoader.addPart('taskTime');
        ...
        .state('task-detail', {
            ...
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'doItApp.task.detail.title'
            },
            views: {
                'content@': {
